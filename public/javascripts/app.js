...
Vue.component('nav-menu', {
    template: `
    <nav class="navbar navbar-expand-lg navbar-dark custom-nav shadow-sm mb-5">
        <div class="container">
...
Vue.component('blog-post', {
    ...
    <div class="card post-card shadow-sm">
        <div class="card-body">
            <img :src="post.profilePic" class="profile-pic mr-4" alt="Profile" @click="$emit('show-profile', post)">
            <h4 class="card-title post-author mb-1">{{ post.author }}</h4>
            <h6 class="card-subtitle post-date mb-3">{{ post.date }}</h6>
            <p class="card-text post-text">
                {{ post.text }}
            </p>
            <div class="text-right mt-3">
                <button class="btn btn-outline-success font-weight-bold" style="border-radius: 20px; padding: 5px 20px;">REPLY</button>
            </div>
    ...
    data: {
        ...
        posts: {
            post1: {
                ...
                level: 'Novice',
                bio: 'Food enthusiast. Love to cook and bake.'
            },
            post2: {
                author: 'LINH',
                ...
                profilePic: 'images/profile.png',
                level: 'Newcomer',
                bio: 'Love food! Exploring new recipes every day.'
            },
            post3: {
                ...
                profilePic: 'images/profile.png',
                level: 'Mentor',
                bio: 'I have to say I never was the adventurous type until 2 years ago. Now I share my food adventures with everyone!'
            },
            post4: {
                author: 'KALI',
